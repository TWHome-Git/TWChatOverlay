    ...
    public static class HelpTopics
    {
        ...
        private static readonly Dictionary<string, (string Title, string Body, string[]? Frames)> Topics = new()
        {
            ...
            ["chat.id.eta_range"] = (
                ...
                "구간: 1~20 / 21~40 / 41~60 / 61~80 / 81~90 / 91 이상 — 각 칸을 눌러 색을 바꿀 수 있습니다.\n" +
            ...
            ["dungeon.content_timer"] = (
                "던전 타이머",
                "던전 클리어 시간을 재는 기능입니다. 채팅 로그에 찍힌 시각으로 계산하며, 클리어되는 순간\n" +
                "지난주 평균 · 직전 판 · 최근 판을 보여줍니다. 구간이 있는 던전은 구간이 끝날 때마다(1보스 처치 등)\n" +
                "끝난 구간까지 보여주고 방금 끝난 구간을 초록색으로 표시합니다. 다른 던전의 시작·완료 줄이 오면 진행 중이던 판은 버립니다.\n" +
                "메뉴 바의 타이머 버튼으로 기록 창을 열고 닫을 수 있고, 창의 작게/크게 버튼으로 모드를 바꿉니다.\n" +
                "기록은 완료한 판만 이번 주와 지난주 것을 보관합니다.\n\n" +
                "대상: 아페티리아 · 어비스 심층 · 신조의 둥지 · 최후의 결전 · 환희의 잔상 · 추종하는 환희 · 응시하는 슬픔 ·\n" +
                "고대 렐릭의 성소 · 이클립스 토벌전 · 이클립스 보스전 · 이클립스 코어\n\n" +
                "일부 컨텐츠는 입장 시각이 로그에 남지 않아 예상 값입니다.\n" +
                "추종하는 환희 · 응시하는 슬픔은 보스 대사 시각에서 일정 시간을 뺀 값이고,\n" +
                "대사 전에 잡으면 '30s↓'처럼 상한만 표시합니다.",
                null),
