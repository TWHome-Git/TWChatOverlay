...
<table>
  <tr>
    <td width="80" valign="top"><img alt="메뉴 바" src="Data/images/Help/readme_menu_bar.png" width="56" /></td>
    <td valign="top">
      <ul>
        <li><b>앱 아이콘</b> — 클릭하면 메뉴를 <b>고정/해제</b>합니다. 고정하면 접히지 않고 항상 펼쳐져 있습니다. 잡고 끌면 메뉴 바를 옮길 수 있습니다.</li>
        <li><b>최소화</b> — 메뉴 바를 제외한 모든 창을 트레이로 숨깁니다. 한 번 더 누르거나 트레이 아이콘을 더블클릭하면 원래대로 돌아옵니다.</li>
        <li><b>말풍선</b> — 대화창(채팅 오버레이)을 열고 닫습니다.</li>
        <li><b>TW DB</b> — <a href="https://talesdb.xyz">TW DB 홈페이지</a>를 브라우저로 엽니다.</li>
        <li><b>체크리스트</b> — 일일/주간 컨텐츠 창을 열고 닫습니다. 주간 득템 통계·어밴던로드 통계·심연의 보물창고 통계도 이 창의 버튼으로 엽니다.</li>
        <li><b>달력</b> — 아이템 획득 내역을 엽니다. 날짜별 획득 아이템과 클리어 보상 시드 합계를 볼 수 있습니다.</li>
        <li><b>외치기</b> — 외치기 로그를 엽니다. 놓친 외치기를 다시 볼 수 있습니다.</li>
        <li><b>M</b> — 메모 창을 엽니다.</li>
        <li><b>자물쇠</b> — 잠금 해제 모드를 켜고 끕니다. 켜져 있는 동안 오버레이 창을 이동·크기 조절할 수 있습니다. (아래 4번 참고)</li>
        <li><b>톱니바퀴</b> — 설정을 엽니다.</li>
        <li><b>전원</b> — 프로그램을 종료합니다.</li>
      </ul>
    </td>
  </tr>
</table>
