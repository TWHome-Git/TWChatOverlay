...
### 3. 메뉴 바
실행하면 화면에 작은 메뉴 바가 뜹니다. 앱 아이콘에 마우스를 올리면 버튼이 펼쳐지고, 마우스가 벗어나면 3초 뒤 다시 접힙니다. 위에서부터 순서대로 다음과 같습니다.

<table>
  <tr>
    <td valign="top"><img alt="메뉴 바" src="Data/images/Help/readme_menu_bar.png" width="64" /></td>
    <td valign="top">
      <table>
        <tr><th>버튼</th><th>기능</th></tr>
        <tr><td><b>앱 아이콘</b></td><td>클릭하면 메뉴를 <b>고정/해제</b>합니다. 고정하면 접히지 않고 항상 펼쳐져 있습니다. 잡고 끌면 메뉴 바를 옮길 수 있습니다.</td></tr>
        <tr><td><b>최소화</b></td><td>메뉴 바를 제외한 모든 창을 트레이로 숨깁니다. 한 번 더 누르거나 트레이 아이콘을 더블클릭하면 원래대로 돌아옵니다.</td></tr>
        <tr><td><b>말풍선</b></td><td>대화창(채팅 오버레이)을 열고 닫습니다.</td></tr>
        <tr><td><b>TW DB</b></td><td><a href="https://talesdb.xyz">TW DB 홈페이지</a>를 브라우저로 엽니다.</td></tr>
        <tr><td><b>체크리스트</b></td><td>일일/주간 컨텐츠 창을 열고 닫습니다. 주간 득템 통계·어밴던로드 통계·심연의 보물창고 통계도 이 창의 버튼으로 엽니다.</td></tr>
        <tr><td><b>달력</b></td><td>아이템 획득 내역을 엽니다. 날짜별 획득 아이템과 클리어 보상 시드 합계를 볼 수 있습니다.</td></tr>
        <tr><td><b>외치기</b></td><td>외치기 로그를 엽니다. 놓친 외치기를 다시 볼 수 있습니다.</td></tr>
        <tr><td><b>M</b></td><td>메모 창을 엽니다.</td></tr>
        <tr><td><b>자물쇠</b></td><td>잠금 해제 모드를 켜고 끕니다. 켜져 있는 동안 오버레이 창을 이동·크기 조절할 수 있습니다. (아래 4번 참고)</td></tr>
        <tr><td><b>톱니바퀴</b></td><td>설정을 엽니다.</td></tr>
        <tr><td><b>전원</b></td><td>프로그램을 종료합니다.</td></tr>
      </table>
    </td>
  </tr>
</table>
