...
클라이언트 메모리를 읽거나 변조하지 않고, 게임이 직접 생성하는 텍스트 로그 파일만 읽습니다.
...
* **1:1 대화 에타 확인** — 1:1 대화(메신저) 창이 열린 후, Log 버튼을 활성화 하면 상대의 에타 레벨을 팝업으로 표시
  테일즈위버의 MsgerLog 폴더를 읽으며, 게임 로그 폴더를 지정하지 않았다면 동작하지 않음

  <img alt="1:1 대화 에타 확인" src="Data/images/Help/readme_messenger_eta.png" width="320" />
...
### 3. 메뉴 바
실행하면 화면에 작은 메뉴 바가 뜹니다. 앱 아이콘에 마우스를 올리면 버튼이 펼쳐지고, 마우스가 벗어나면 3초 뒤 다시 접힙니다. 그림의 번호 순서대로 다음과 같습니다.

<table>
  <tr>
    <td width="100" valign="top"><img alt="메뉴 바" src="Data/images/Help/readme_menu_bar.png" width="85" /></td>
    <td valign="top">
      <ol>
        <li><b>메뉴 고정/해제</b> — 앱 아이콘을 클릭하면 메뉴가 고정되어 접히지 않습니다. 잡고 끌면 메뉴 바를 옮길 수 있습니다.</li>
        <li><b>최소화</b> — 메뉴 바를 제외한 모든 창을 트레이로 숨깁니다. 한 번 더 누르거나 트레이 아이콘을 더블클릭하면 원래대로 돌아옵니다.</li>
        <li><b>대화창</b> — 채팅 오버레이를 열고 닫습니다.</li>
        <li><b>TW DB</b> — <a href="https://talesdb.xyz">TW DB 홈페이지</a>를 브라우저로 엽니다.</li>
        <li><b>일일/주간 컨텐츠</b> — 체크리스트 창을 열고 닫습니다. 주간 득템 통계·어밴던로드 통계·심연의 보물창고 통계도 이 창의 버튼으로 엽니다.</li>
        <li><b>아이템 획득 내역</b> — 달력을 엽니다. 날짜별 획득 아이템과 클리어 보상 시드 합계를 볼 수 있습니다.</li>
        <li><b>외치기 로그</b> — 놓친 외치기를 다시 볼 수 있습니다.</li>
        <li><b>메모</b> — 메모 창을 엽니다.</li>
        <li><b>잠금 해제 모드</b> — 켜져 있는 동안 오버레이 창을 이동·크기 조절할 수 있습니다. (아래 4번 참고)</li>
        <li><b>설정</b> — 설정 창을 엽니다.</li>
        <li><b>종료</b> — 프로그램을 종료합니다.</li>
      </ol>
    </td>
  </tr>
</table>

### 4. 창 위치·크기 조정 (잠금 해제 모드)
...
## 주의 사항
* **데이터 방식** — 메모리를 읽거나 변조하지 않으며, 게임이 생성하는 텍스트 로그 파일만 읽습니다.
